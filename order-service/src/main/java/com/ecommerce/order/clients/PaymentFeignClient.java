 ...
 * 
 * @FeignClient(name="inventory-service") public interface PaymentFeignClient {
 * 
 * @GetMapping(value = "/v1/inventory/availability/{productId}") public
 * InventoryAvailabilityDTO getAvailability(
 * 
